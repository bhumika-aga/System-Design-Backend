# the REAL FastAPI app (dependencies may be overridden with fakes sec 6)
from app import app
from fastapi.testclient import TestClient

# drives the app in-process, no network, no running server
...
# so the handler runs but the repo is in-memory: an integration test
# of the web layer.
